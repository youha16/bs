    ...
    <div>
        ...
        <app-body style="width:100%;">
            ...
            <div class="block">
                ...
                <el-carousel-item v-for="(idle,index) in idleList" >
                    <el-image @click="toDetails(idle)"
            ...
            <div style="padding-left:7%; width: 100%;height: auto;flex: 9;margin-top: 20px;">
                <span class="alltitle">全部商品</span>
                <el-row :gutter="30">
