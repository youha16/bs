    ...
    <div>
        ...
        <app-body style="width:100%;">
            ...
            <div style="display: flex;">
                <div style="width: 100%;height: auto;flex: 1">
            <el-tabs v-model="labelName" tabPosition="left" @tab-click="handleClick" >
                <!-- <el-tab-pane label="全部" name="0"></el-tab-pane> -->
                <el-tab-pane label="数码" name="1"></el-tab-pane>
                <el-tab-pane label="家电" name="2"></el-tab-pane>
                <el-tab-pane label="衣服" name="3"></el-tab-pane>
                <el-tab-pane label="图书" name="4"></el-tab-pane>
                <el-tab-pane label="其他" name="5"></el-tab-pane>
            </el-tabs>
            </div>
            <div style="width: 100%;height: auto;flex: 9">
                <el-row :gutter="30">
                    <el-col :span="30" v-for="(idle,index) in idleList">
